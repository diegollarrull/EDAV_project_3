...
response = yelp_api.search_query(term='ice cream', location='austin, tx', sort=2, limit=20, offset=20)
pprint(response)
...
response = yelp_api.search_query(term='alcohol', location='Montgomery County, MD', sort=2, limit=5)
pprint(response)
